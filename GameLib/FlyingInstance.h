...
protected:
	...
	void __SetTargetNormalizedDirection(const D3DXVECTOR3 & v3NomalizedDirection);

#ifdef ENABLE_SKILL_COLOR_SYSTEM
public:
	void	SetSkillColor(uint32_t* dwSkillColor) { memcpy(m_dwSkillColor, dwSkillColor, sizeof(m_dwSkillColor)); }

protected:
	uint32_t	m_dwSkillColor[ESkillColorLength::MAX_EFFECT_COUNT];
#endif
...
protected:
	IActorInstance* m_pOwner2;

public:
	void SetOwner2(IActorInstance* pOwner) { m_pOwner2 = pOwner; }
#endif
};
