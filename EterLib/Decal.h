...
protected:
	...
	uint32_t ClipPolygon(uint32_t dwVertexCount, const D3DXVECTOR3 * c_pv3Vertex, const D3DXVECTOR3 * c_pv3Normal,
						 D3DXVECTOR3 * c_pv3NewVertex, D3DXVECTOR3 * c_pv3NewNormal) const;
	static uint32_t ClipPolygonAgainstPlane(const D3DXPLANE & c_rv4Plane, uint32_t dwVertexCount, const D3DXVECTOR3 * c_pv3Vertex,
