...
void CColorTransitionHelper::Clear(const float & c_rfRed, const float & c_rfGreen, const float & c_rfBlue, const float & c_rfAlpha)
{
	m_fSrcRed = c_rfRed;
...
void CColorTransitionHelper::SetSrcColor(const float & c_rfRed, const float & c_rfGreen, const float & c_rfBlue, const float & c_rfAlpha)
{
	m_fSrcRed = c_rfRed;
	m_fSrcGreen = c_rfGreen;
	m_fSrcBlue = c_rfBlue;
...
void CColorTransitionHelper::SetTransition(const float & c_rfRed, const float & c_rfGreen, const float & c_rfBlue, const float & c_rfAlpha,
...
bool CColorTransitionHelper::Update()
{
	...
	m_dwCurColor = (((uint32_t)(fCurAlpha * 255.0f) & 0xff) << 24) | (((uint32_t)(fCurRed * 255.0f) & 0xff) << 16) |
		(((uint32_t)(fCurGreen * 255.0f) & 0xff) << 8) | ((uint32_t)(fCurBlue * 255.0f) & 0xff);
