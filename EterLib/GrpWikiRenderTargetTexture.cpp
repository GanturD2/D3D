...
CGraphicWikiRenderTargetTexture::CGraphicWikiRenderTargetTexture() : m_d3dFormat{ D3DFMT_UNKNOWN }, m_depthStencilFormat{ D3DFMT_UNKNOWN }
{
	Initialize();
...
void CGraphicWikiRenderTargetTexture::SetRenderTarget()
{
	...
	{
#ifdef _DEBUG
		TraceError("GrpWikiRenderTargetTexture.cpp::SetRenderTarget : Unable to Set Render Target");
#endif _DEBUG

		Create(m_width, m_height, m_d3dFormat, m_depthStencilFormat);

#ifdef _DEBUG
		TraceError("GrpWikiRenderTargetTexture.cpp::SetRenderTarget : Reset Render Target\n");
#endif _DEBUG
...
{
	ms_lpd3dDevice->Clear(0L, NULL, D3DCLEAR_TARGET | D3DCLEAR_ZBUFFER, D3DCOLOR_XRGB(0x0, 0x0, 0x0), 1.0f, 0);	// Black Shadow BG

#ifdef _DEBUG
	bool bSuccess = true;

	if (FAILED(ms_lpd3dDevice->Clear(0L, NULL, D3DCLEAR_TARGET | D3DCLEAR_ZBUFFER, D3DCOLOR_XRGB(0x0, 0x0, 0x0), 1.0f, 0)))	// Black BG
	{
