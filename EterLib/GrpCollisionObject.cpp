											...
											D3DXVECTOR3 & RayOriginal, D3DXVECTOR3 & RayDirection, float * pu, float * pv, float * pt)
{
	...
	static const WORD c_awFillCubeIndices[36] = {0, 1, 2, 1, 3, 2, 2, 0, 6, 0, 4, 6, 0, 1, 4, 1, 5, 4,
...
bool CGraphicCollisionObject::IntersectMesh(const D3DXMATRIX * c_pmatWorld, const void * vertices, DWORD dwStep, DWORD dwvtxCount,
											D3DXVECTOR3 & RayOriginal, D3DXVECTOR3 & RayDirection, float * pu, float * pv, float * pt)
{
	auto * pcurVtx = (char *) vertices;
